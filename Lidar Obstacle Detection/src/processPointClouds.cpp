...
typename pcl::PointCloud<PointT>::Ptr ProcessPointClouds<PointT>::FilterCloud(typename pcl::PointCloud<PointT>::Ptr cloud, float filterRes, Eigen::Vector4f minPoint, Eigen::Vector4f maxPoint)
{
    ...
    typename pcl::PointCloud<PointT>::Ptr cloud_filterd (new pcl::PointCloud<PointT>);
    ...
    region.setInputCloud(cloud_filterd);
    region.filter(*CloudRegion);
    //roof
    typename pcl::PointCloud<PointT>::Ptr Roofcloud (new pcl::PointCloud<PointT>);
    ...
    std::cerr << "after Filtering " << CloudRegion->points.size ()  << std::endl;
    return CloudRegion;
...
std::pair<typename pcl::PointCloud<PointT>::Ptr, typename pcl::PointCloud<PointT>::Ptr> ProcessPointClouds<PointT>::SeparateClouds(pcl::PointIndices::Ptr inliers, typename pcl::PointCloud<PointT>::Ptr cloud) 
{
  // TODO: Create two new point clouds, one cloud with obstacles and other with segmented plane
    ...
    typename pcl::PointCloud<PointT>::Ptr planar (new pcl::PointCloud<PointT> ());
    for (int index : inliers->indices){
        planar->points.push_back(cloud->points[index]);
    }
    ...
    std::pair<typename pcl::PointCloud<PointT>::Ptr, typename pcl::PointCloud<PointT>::Ptr> segResult(Obstacles, planar);
...
std::vector<typename pcl::PointCloud<PointT>::Ptr> ProcessPointClouds<PointT>::Clustering(typename pcl::PointCloud<PointT>::Ptr cloud, float clusterTolerance, int minSize, int maxSize)
{
    ...
    std::vector<pcl::PointIndices> clusters_indcies;
    ...
    ec.extract(clusters_indcies);

    for(pcl::PointIndices point_ind : clusters_indcies){
        typename pcl::PointCloud<PointT>::Ptr CloudCluster (new pcl::PointCloud<PointT>);
        for (int index : point_ind.indices)
